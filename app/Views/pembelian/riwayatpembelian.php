...
<div class="my-3 p-3 bg-body rounded shadow-sm">
  ...
  <div class="d-flex justify-content-between border-bottom py-2">
    ...
    <a href="<?= site_url('/pembelian') ?>" class="btn btn-primary"> + Tambah</a>
  </div>
  ...
  <div class="pt-3">
          ...
          <?php if (!empty($riwayat)) : ?>
            <?php $no = 1; foreach ($riwayat as $row) : ?>
              <tr>
                ...
                <td>
                  <form action="<?= site_url('/pembelian/delete/' . $row['id_riwayat']) ?>" method="post" class="d-inline form-delete">
                    <?= csrf_field() ?>
    ...
    <a href="<?= site_url('/asset') ?>" class="btn btn-secondary mt-3">Kembali</a>
  </div>
</div>
