...
$(document).ready(function () {
  ...
  function updateExportLinks() {
    ...
    $('#pdfExportBtn').attr('href', `<?= site_url() ?>/laporan/kendaraan/pdf/${tahun}?jenis=${encodeURIComponent(jenis)}`);
    $('#excelExportBtn').attr('href', `<?= site_url() ?>/laporan/kendaraan/excel/${tahun}?jenis=${encodeURIComponent(jenis)}`);
  }
