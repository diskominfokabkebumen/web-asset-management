...
$(document).ready(function() {
  ...
  function updateSubKategori() {
    ...
    if (selectedKategori === '') {
      ...
      $.get('<?= site_url('laporan/asset/sub-kategori') ?>', { kategori: selectedKategori })
        .done(function(data) {
          subKategoriSelect.html('<option value="">Semua Sub Kategori</option>');
  ...
  function updateNamaBarang() {
    ...
    if (selectedSubKategori === '') {
      ...
      $.get('<?= site_url('laporan/asset/nama-barang') ?>', { sub_kategori: selectedSubKategori })
        .done(function(data) {
          namaBarangSelect.html('<option value="">Semua Barang</option>');
          $.each(data, function(index, item) {
  ...
  function updatePreviewTable() {
    ...
    $.get('<?= site_url('laporan/asset/data-filter') ?>', {
      kategori: kategori,
  ...
  function generateExportUrl(format) {
    ...
    return `<?= site_url('laporan/asset/') ?>${format}?${params.toString()}`;
  }
