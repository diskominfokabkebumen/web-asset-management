...
<?= $this->section('content'); ?>
  ...
  $(document).ready(function () {
    ...
    function updateExportLinks() {
      ...
      $('#pdfExportBtn').attr('href', '<?= site_url()?>/laporan/pemakaian/pdf?tahun=' + tahun + '&kategori=' + kategoriKode + '&sub_kategori=' + subKategoriKode);
      $('#excelExportBtn').attr('href', '<?= site_url()?>/laporan/pemakaian/excel?tahun=' + tahun + '&kategori=' + kategoriKode + '&sub_kategori=' + subKategoriKode);
    }
