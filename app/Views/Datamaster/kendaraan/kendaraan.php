...
<div class="my-3 p-3 bg-body rounded shadow-sm">
    <div class="d-flex justify-content-between border-bottom py-2">
        ...
        <a href="<?= site_url('kendaraan/create')?>" class="btn btn-primary">Tambah Kendaraan</a>
    </div>
                ...
                <?php if (!empty($kendaraan)) : ?>
                    <?php $no = 1; foreach ($kendaraan as $ken) : ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?= site_url('kendaraan/show/'. $ken['id']) ?>" class="btn btn-info btn-sm">Detail</a>
                                <a href="<?= site_url('kendaraan/edit/'. $ken['id']) ?>" class="btn btn-warning btn-sm">Edit</a>
