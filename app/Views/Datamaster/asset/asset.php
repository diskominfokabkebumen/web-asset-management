...
<div class="my-3 p-3 bg-body rounded shadow-sm">
  ...
  <div class="d-flex justify-content-between border-bottom py-2">
    ...
    <a href="<?= site_url('asset/create') ?>" class="btn btn-primary">Tambah Data</a>
  </div>
          ...
          <?php if (!empty($assets)) : ?>
            <?php $no = 1; foreach ($assets as $asset) : ?>
              <tr>
                ...
                <td>
                  <a href="<?= site_url('asset/edit/' . $asset['id']) ?>" class="btn btn-warning btn-sm">Edit</a>
                  <form action="<?= site_url('asset/delete/' . $asset['id']) ?>" method="post" class="d-inline form-delete">
                    <?= csrf_field() ?>
