...
<div class="my-3 p-3 bg-body rounded shadow-sm">
  ...
  <div class="d-flex justify-content-between border-bottom py-2">
    ...
    <a href="<?= site_url('pengguna/create') ?>" class="btn btn-primary">Tambah Data</a>
  </div>
          ...
          <?php if (!empty($pengguna)) : ?>
            <?php $no = 1; foreach ($pengguna as $peng) : ?>
              <tr>
                ...
                <td>
                  <a href="<?= site_url('/pengguna/edit/' . $peng['id']) ?>" class="btn btn-warning btn-sm">Edit</a>
                  <form action="<?= site_url('/pengguna/delete/' . $peng['id']) ?>" method="post" class="d-inline form-delete">
                    <?= csrf_field() ?>
