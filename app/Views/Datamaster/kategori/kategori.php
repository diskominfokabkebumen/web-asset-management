...
<div class="my-3 p-3 bg-body rounded shadow-sm">
    <div class="d-flex justify-content-between border-bottom py-2">
        ...
        <a href="<?= site_url('kategori/create') ?>" class="btn btn-primary">Tambah Data</a>
    </div>
                ...
                <?php if (!empty($kategori)) : ?>
                    <?php foreach ($kategori as $key => $row) : ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?= site_url('kategori/edit/'. $row['id']) ?>" class="btn btn-warning btn-sm">Edit</a>
                                <form action="<?= site_url('kategori/delete/'. $row['id']) ?>" method="post" class="d-inline form-delete">
                                    <?= csrf_field() ?>
