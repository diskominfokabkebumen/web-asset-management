...
<div class="my-3 p-3 bg-body rounded shadow-sm">
  ...
  <div class="d-flex justify-content-between border-bottom py-2 mb-3">
    ...
    <a href="<?= site_url('lokasi/create') ?>" class="btn btn-primary">Tambah Data</a>
  </div>
        ...
        <tbody>
          <?php $no = 1; foreach ($lokasi as $lok) : ?>
            <tr>
              ...
              <td>
                <a href="<?= site_url('/lokasi/edit/' . $lok['id']) ?>" class="btn btn-sm btn-primary">Edit</a>
                <form action="<?= site_url('/lokasi/delete/' . $lok['id']) ?>" method="post" class="d-inline form-delete">
                  <?= csrf_field() ?>
