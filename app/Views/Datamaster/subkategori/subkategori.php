...
<div class="my-3 p-3 bg-body rounded shadow-sm">
    <div class="d-flex justify-content-between border-bottom py-2">
        ...
        <a href="<?= site_url('subkategori/create') ?>" class="btn btn-primary">Tambah Data</a>
    </div>
                ...
                <?php if (!empty($sub_kategori)) : ?>
                    <?php foreach ($sub_kategori as $key => $row) : ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?= site_url('subkategori/edit/' . $row['id']) ?>" class="btn btn-warning btn-sm">Edit</a>
                                <form action="<?= site_url('subkategori/delete/' . $row['id']) ?>" method="post" class="d-inline form-delete">
                                    <?= csrf_field() ?>
