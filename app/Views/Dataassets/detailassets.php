...
<div class="my-3 p-3 bg-body rounded shadow-sm">
  ...
  <div class="d-flex justify-content-between border-bottom py-2 mb-3">
    ...
    <a href="<?= site_url('/dataassets') ?>" class="btn btn-primary">Kembali</a>
  </div>
                ...
                <td>
                  ...
                  <?php if ($isHabisTerpakai): ?>
                    ...
                    <div class="btn-group-sm d-flex flex-wrap gap-1">
                      <a href="<?= site_url('/dataassets/detail/' . $asset['id']) ?>" 
                         class="btn btn-sm btn-info" title="Lihat Detail">
                        <i class="fas fa-eye"></i> Detail
                      </a>
                      
                      <form action="<?= site_url('/dataassets/delete/' . $asset['id']) ?>" 
                  ...
                  <?php else: ?>
                    ...
                    <div class="btn-group-sm d-flex flex-wrap gap-1">
                      <a href="<?= site_url('/dataassets/edit/' . $asset['id']) ?>" 
