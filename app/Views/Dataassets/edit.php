...
<div class="my-3 p-3 bg-body rounded shadow-sm">
    ...
    <form action="<?= site_url('/dataassets/update/' . $barang['id']) ?>" method="post">
        <?= csrf_field() ?>
        ...
        <a href="<?= site_url('/dataassets/detail/' . $barang['kode_sub_kategori']) ?>" class="btn btn-primary">Kembali</a>
        </form>
    </form>
</div>
