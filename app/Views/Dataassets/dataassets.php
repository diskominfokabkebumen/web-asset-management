...
<div class="my-3 p-3 bg-body rounded shadow-sm">
  ...
  <div class="row mb-3">
    <div class="col-md-4">
      <form method="GET" action="<?= site_url('dataassets') ?>">
    ...
    <div class="col-md-8 d-flex align-items-end">
      <?php if ($selected_kategori) : ?>
        <div class="alert alert-info mb-0">
          ...
          <a href="<?= site_url('dataassets') ?>" class="btn btn-sm btn-secondary ml-2">Reset Filter</a>
        </div>
      <?php endif; ?>
    </div>
  </div>
        ...
        <?php if (!empty($sub_kategori)) : ?>
          <?php foreach ($sub_kategori as $i => $sub) : ?>
            <tr>
              ...
              <td>
                <a href="<?= site_url('dataassets/detailSubKategori/' . $sub['kode_sub_kategori']) ?>" class="btn btn-info btn-sm">
